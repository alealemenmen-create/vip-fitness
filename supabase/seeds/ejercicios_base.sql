...
('aperturas-mancuernas-inclinado', 'Aperturas con mancuernas inclinado', array['aperturas inclinado','vuelos inclinado','incline flyes','aperturas banco inclinado'],
 'pecho', array['hombros'], 'aislamiento', 'mancuerna', 'intermedio',
 'Igual que las aperturas planas, pero en banco inclinado: carga la parte alta del pecho.',
 'Banco entre 30 y 45 grados. Codos levemente flexionados y fijos, abre hasta sentir el estiramiento y cierra como si abrazaras un barril.',
 array['Inclinar el banco más de 45 grados y perder tensión en el pecho','Flexionar los codos y convertirlo en un press'],
 array['Es un ejercicio de sensación, no de peso máximo'],
 'aperturas-inclinado'),
...
('pullover-mancuerna', 'Pullover con mancuerna', array['pullover mancuerna','dumbbell pullover','pullover banco'],
 'espalda', array['pecho'], 'aislamiento', 'mancuerna', 'intermedio',
 'Pullover con una mancuerna, acostado en el banco: estira dorsal y pecho a la vez.',
 'Acostado en el banco, sostén una mancuerna con ambas manos por encima del pecho. Baja los brazos casi rectos detrás de la cabeza hasta sentir el estiramiento, y volvé al punto de partida sin doblar mucho los codos.',
 array['Flexionar demasiado los codos y que se vuelva un press','Bajar más de lo que permite el hombro'],
 array['Mantén el core firme para no arquear la espalda baja','Es un buen ejercicio para abrir la caja torácica'],
 'pullover-mancuerna'),
...
('curl-femoral-sentado', 'Curl femoral sentado', array['femoral sentado','seated leg curl','curl piernas sentado'],
 'piernas', array[]::text[], 'aislamiento', 'maquina', 'principiante',
 'Curl femoral en máquina sentada: el respaldo evita que ayudes con la cadera.',
 'Sentado con el respaldo del muslo ajustado y el rodillo apoyado justo sobre los tobillos. Flexiona las rodillas llevando el rodillo hacia abajo, y volvé controlado.',
 array['Levantar la cadera del asiento','Soltar de golpe en la vuelta'],
 array['Complementa bien al femoral tumbado, no lo reemplaza'],
 'curl-femoral-sentado'),

('curl-femoral-pie', 'Curl femoral de pie', array['femoral de pie','standing leg curl','curl femoral parado','femoral unilateral de pie'],
 'piernas', array[]::text[], 'aislamiento', 'maquina', 'intermedio',
 'Curl femoral de pie, una pierna a la vez, en máquina o polea con tobillera.',
 'De pie, con el tobillo enganchado al rodillo o a la tobillera de la polea. Flexiona la rodilla llevando el talón hacia el glúteo, sin balancear la cadera.',
 array['Balancear la cadera para ayudarse','Bajar de golpe sin control'],
 array['Permite corregir diferencias entre piernas, igual que el femoral unilateral tumbado'],
 'curl-femoral-pie'),
...
('gemelos-prensa', 'Gemelos en prensa', array['gemelos en prensa','pantorrilla en prensa','calf press','prensa gemelos'],
 'piernas', array[]::text[], 'aislamiento', 'maquina', 'principiante',
 'Gemelo empujando con la punta del pie en la prensa de piernas.',
 'Sentado en la prensa, apoya solo la punta de los pies en la plataforma. Empuja extendiendo el tobillo y baja hasta estirar el gemelo.',
 array['Usar rango de movimiento corto'],
 array['Permite cargar bastante peso sin comprometer la espalda'],
 'gemelos-prensa'),
...
('curl-polea-alta', 'Curl de bíceps en polea alta', array['curl polea alta','high cable curl','curl biceps polea alta'],
 'brazos', array[]::text[], 'aislamiento', 'polea', 'intermedio',
 'Curl de bíceps con las poleas ajustadas en alto, brazos abiertos a los costados.',
 'De pie en el centro de la máquina de poleas, un cable en cada mano ajustado en la posición alta. Lleva los puños hacia la cabeza manteniendo los codos elevados y fijos, sintiendo el pico del bíceps.',
 array['Bajar los codos durante el movimiento','Usar el hombro para impulsar la subida'],
 array['Mantén los codos a la altura del hombro durante todo el recorrido','Es un buen cierre para el bíceps: mucha tensión en el pico'],
 'curl-polea-alta'),
...
('plancha-alta', 'Plancha alta', array['high plank','plancha con brazos extendidos','plancha en manos'],
 'core', array['hombros'], 'core', 'peso_corporal', 'principiante',
 'Igual que la plancha pero apoyada en las manos con los brazos extendidos.',
 'Apoyo en las manos, brazos extendidos y alineados debajo de los hombros. Cuerpo en línea recta, abdomen y glúteos apretados, igual que la plancha en antebrazos.',
 array['Subir la cadera','Hundir la espalda baja','Bloquear los codos de golpe'],
 array['Exige más de hombros y muñecas que la versión en antebrazos','Buena opción de transición hacia flexiones'],
 'plancha-alta'),
...
('elevacion-piernas', 'Elevación de piernas', array['leg raise','elevaciones de pierna','abdominal inferior'],
 'core', array[]::text[], 'core', 'peso_corporal', 'intermedio',
 'Abdomen bajo, acostado en el piso.',
...
('elevacion-piernas-colgado', 'Elevación de piernas colgado', array['hanging leg raise','colgado de la barra','elevacion piernas barra','elevacion piernas colgado'],
 'core', array[]::text[], 'core', 'peso_corporal', 'avanzado',
 'La versión más exigente: colgado de la barra, sin apoyo, piernas rectas.',
 'Colgado de una barra con las manos, sin tocar el piso. Sube las piernas rectas hasta la horizontal o más, sin balancear el cuerpo, y baja controlado.',
 array['Balancear el cuerpo para tomar impulso','Doblar mucho las rodillas y perder el trabajo de abdomen bajo'],
 array['Si no llegás a piernas rectas, doblá las rodillas: sigue siendo válido mientras no balancees'],
...
('patada-gluteo-polea', 'Patada de glúteo en polea', array['patada gluteo cable','cable kickback','patada de gluteo polea baja'],
 'piernas', array[]::text[], 'aislamiento', 'polea', 'principiante',
 'Patada de glúteo de pie en la polea baja, pierna por pierna.',
 'De pie frente a la polea baja con el tobillo enganchado al cable. Sujeto del marco para estabilidad, empuja la pierna hacia atrás apretando el glúteo, sin usar impulso de la espalda.',
 array['Arquear la espalda baja para ganar rango','Usar impulso en vez de controlar el movimiento'],
 array['Rango corto y controlado, sin necesidad de mucho peso','Aprieta el glúteo arriba antes de volver'],
 'patada-gluteo-polea'),
...
('push-press', 'Push Press', array['press con impulso','empuje de piernas press'],
 'hombros', array['piernas','core'], 'full_body', 'barra', 'avanzado',
 'Press militar con impulso de piernas: permite mover más peso overhead.',
 'Barra en los hombros como en el press militar. Flexiona un poco las rodillas y extendé explosivo empujando la barra hacia arriba con el impulso de las piernas.',
 array['Convertirlo en una sentadilla en vez de un press','Perder el equilibrio hacia atrás'],
 array['El impulso es corto y rápido, no una sentadilla completa'],
 'sentadilla-frontal'),
...
('sentadilla-libre-trasera', 'Sentadilla libre trasera', array['sentadilla libre','back squat','super squat','sentadilla trasera libre'],
 ...
 'sentadilla-libre-trasera'),

-- ── AGREGADOS AL PROCESAR LAS FOTOS DEL GIMNASIO (faltaban en la carga inicial) ──

('sissy-squat', 'Sissy Squat', array['sissy squat'],
 'piernas', array[]::text[], 'pierna', 'peso_corporal', 'avanzado',
 'Sentadilla de aislamiento de cuádriceps, inclinando el torso atrás y las rodillas muy adelante.',
 'Sostenido de un soporte fijo, talones levantados, inclina el torso hacia atrás mientras doblas las rodillas hacia adelante, bajando en línea recta.',
 array['Perder el equilibrio hacia atrás','No usar soporte y arriesgar la rodilla'],
 array['Empieza con poco rango hasta dominar el equilibrio'],
 'sissy-squat'),

('sentadilla-sumo', 'Sentadilla sumo', array['sumo squat','sentadilla sumo barra','wide stance squat'],
 'piernas', array[]::text[], 'pierna', 'barra', 'intermedio',
 'Sentadilla con las piernas muy abiertas: más glúteo y aductor.',
 'Pies bien abiertos con las puntas hacia afuera. Baja manteniendo el torso lo más vertical posible y las rodillas en línea con los pies.',
 array['Juntar las rodillas al bajar','Perder la verticalidad del torso'],
 array['Buena opción si sentís mucho cuádriceps y poco glúteo en la sentadilla normal'],
 'sentadilla-sumo'),

('kettlebell-swing', 'Kettlebell Swing', array['swing','russian swing','kb swing'],
 'core', array['piernas'], 'full_body', 'kettlebell', 'intermedio',
 'Movimiento explosivo de cadera con kettlebell: cardio y potencia.',
 'Pies al ancho de hombros, kettlebell entre las piernas. Con un golpe de cadera (no de brazos) impulsa el kettlebell hasta la altura del pecho, dejalo caer controlado y repetí.',
 array['Hacer sentadilla en vez de bisagra de cadera','Usar los brazos para levantar el peso'],
 array['La potencia sale de la cadera, los brazos solo guían'],
 'kettlebell-swing'),

('pull-through', 'Pull Through', array['cable pull through','jalon entre piernas'],
 'piernas', array['espalda'], 'pierna', 'polea', 'intermedio',
 'Bisagra de cadera tirando de una cuerda entre las piernas, con tensión constante de la polea.',
 'De espaldas a la polea baja con la cuerda entre las piernas. Con las rodillas semiflexionadas, empuja la cadera atrás y después extendé llevando la cadera adelante.',
 array['Convertirlo en un remo con los brazos','Redondear la espalda baja'],
 array['Buen ejercicio para aprender la bisagra de cadera sin cargar la espalda'],
 'pull-through'),

('curl-concentrado', 'Curl concentrado', array['concentration curl','curl concentrado sentado'],
 'brazos', array[]::text[], 'aislamiento', 'mancuerna', 'principiante',
 'Curl de bíceps sentado con el codo apoyado en el muslo: aislamiento total.',
 'Sentado, codo apoyado en la cara interna del muslo del mismo lado. Sube la mancuerna con control, sin balancear el cuerpo.',
 array['Despegar el codo del muslo','Usar impulso del torso'],
 array['Es de los mejores ejercicios para sentir el pico del bíceps'],
 'curl-concentrado'),

('jalon-agarre-cerrado', 'Jalón agarre cerrado', array['jalon cerrado','close grip pulldown','jalon triangulo'],
 'espalda', array[]::text[], 'traccion', 'polea', 'principiante',
 'Jalón al pecho con agarre cerrado (triángulo o barra V): más contracción del dorsal medio.',
 'Sentado frente a la polea alta con el agarre cerrado o triángulo. Lleva el agarre hacia el pecho alto, codos pegados al cuerpo.',
 array['Balancear el torso hacia atrás para ayudarse','Bajar solo con los brazos sin activar la espalda'],
 array['El agarre cerrado carga más el centro de la espalda que el agarre ancho'],
 'jalon-agarre-cerrado'),

('buenos-dias', 'Buenos días', array['good morning','good mornings'],
 'espalda', array['piernas'], 'traccion', 'barra', 'avanzado',
 'Bisagra de cadera con la barra en la espalda alta, como el rumano pero con la barra sobre los hombros.',
 'Barra apoyada en los trapecios como en la sentadilla. Con las rodillas semiflexionadas, inclina el torso hacia adelante empujando la cadera atrás, y volvé a subir.',
 array['Redondear la espalda baja','Usar demasiado peso antes de dominar la técnica'],
 array['Empezá con poco peso: acá la técnica manda más que en cualquier otro ejercicio de cadera'],
 'buenos-dias'),

('crunch-maquina', 'Crunch en máquina', array['abdominal maquina','crunch machine','maquina de abdominales'],
 'core', array[]::text[], 'aislamiento', 'maquina', 'principiante',
 'Crunch guiado en máquina: permite sumar peso progresivo al abdomen.',
 'Sentado con el pecho contra la almohadilla. Flexiona el torso hacia adelante contrayendo el abdomen, sin tirar con los brazos.',
 array['Tirar con los brazos en vez de con el abdomen'],
 array['Es de los pocos abdominales donde podés progresar en peso de forma clara'],
 'crunch-maquina'),

('dead-bug', 'Dead Bug', array['dead bugs'],
 'core', array[]::text[], 'core', 'peso_corporal', 'principiante',
 'Ejercicio de control de core: mueve brazo y pierna opuestos sin perder la zona lumbar pegada al piso.',
 'Acostado boca arriba, brazos hacia el techo y rodillas a 90 grados. Baja un brazo y la pierna opuesta hacia el piso sin despegar la espalda baja, y volvé.',
 array['Despegar la espalda baja del piso','Ir muy rápido'],
 array['Es más de control que de fuerza: mejor lento y perfecto'],
 'dead-bug'),

('frog-pumps', 'Frog Pumps', array['puente rana','frog pump'],
 'piernas', array[]::text[], 'aislamiento', 'peso_corporal', 'principiante',
 'Puente de glúteo con las plantas de los pies juntas: aísla mucho el glúteo.',
 'Acostado boca arriba, plantas de los pies juntas y rodillas abiertas hacia los costados. Sube y baja la cadera en pulsos cortos apretando el glúteo.',
 array['Usar rango muy grande y perder tensión'],
 array['Va bien como activación antes de sentadilla o peso muerto'],
 'frog-pumps'),

('remo-hammer', 'Remo Hammer', array['hammer strength row','remo maquina hammer','iso lateral row'],
 'espalda', array['brazos'], 'traccion', 'maquina', 'principiante',
 'Remo en máquina de brazos independientes: cada lado se mueve solo.',
 'Pecho apoyado en el respaldo, toma las manijas y tira hacia atrás llevando los codos pegados al cuerpo.',
 array['Usar impulso del cuerpo en vez de la espalda'],
 array['Al ser independiente, ayuda a corregir descompensaciones entre lados'],
 'remo-hammer'),

('puente-gluteos', 'Puente de glúteos', array['glute bridge','puente de cadera','hip bridge'],
 'piernas', array[]::text[], 'aislamiento', 'peso_corporal', 'principiante',
 'La versión sin barra del hip thrust, con la espalda apoyada en el piso.',
 'Acostado boca arriba, rodillas flexionadas y pies apoyados. Empuja la cadera hacia arriba apretando el glúteo, y bajá controlado.',
 array['Arquear mucho la espalda baja en vez de usar el glúteo'],
 array['Buen punto de partida antes de pasar al hip thrust con barra'],
 'puente-gluteos'),

('extension-triceps-unilateral', 'Extensión unilateral de tríceps', array['extension unilateral','triceps unilateral','pushdown a una mano'],
 'brazos', array[]::text[], 'aislamiento', 'polea', 'principiante',
 'Extensión de tríceps en polea, un brazo a la vez.',
 'De pie frente a la polea alta con agarre de una mano. Extendé el codo hacia abajo sin mover el hombro, y volvé controlado.',
 array['Mover el codo hacia adelante y atrás'],
 array['Permite corregir diferencias de fuerza entre brazos'],
